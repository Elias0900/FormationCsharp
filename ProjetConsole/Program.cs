...
Formation c#";
            ...
            Console.WriteLine($"La moyenne des éléments de tableau {MesMethodes.Moyenne(tableau)}");
            Console.WriteLine($"L'élément min du tableau : {MesMethodes.Minimum(tableau)}");

            // Appel de la méthode qui prend des param optionnels 

            MesMethodes.SommeOptional(10, 20); // on récupère 40 pour z

            MesMethodes.SommeOptional(10, 20, 40); // On récupère 70 pour z 


            int valeur1 = 10, valeur2 = 20;

            Console.WriteLine($"Avant permutation : valeur 1 = {valeur1} - valeur 2 ={valeur2}"); // 10 - 20
            MesMethodes.Permuter(ref valeur1, ref valeur2);

            Console.WriteLine($"Après permutation : valeur 1 = {valeur1} - valeur 2 = {valeur2}"); //20 - 10

            // Appel de la méthode avec des param de sortie
