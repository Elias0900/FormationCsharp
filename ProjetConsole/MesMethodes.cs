...
namespace ProjetConsole
{
    public class MesMethodes
    {
        ...
        {
            // Mettre en place la structure de somme
            int somme = 0;
            foreach (var item in tab)
            {
                somme += item;
        ...
        // Ils possèdent des valeurs par défaut et doivent être définis à la fin de la liste des paramètres
        public static int SommeOptional(int x, int y, int z = 10)
            // z est un paramètre optionnel : Il possède une valeur par défaut
        {
            return x + y + z;
        }
        ...
        // Methode de paramètres par référence
        // Le mot clé s'utilise uniquement avec les types simples (type valeur) - pour les types complexes par
        // par def ce sont des types références
